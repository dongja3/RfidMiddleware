...
<html>
<head>
	<title><fmt:message key="editHttpCommandReply.title" /></title>
	...
	<script>
	    function httpCommandSubmit(){
			...
			if(isEmpty(path)){
				...
				var e =/^([/]|[\w])([\w]+[/]?[\w]*)*$/;
				if(!e.test(document.forms[0].path.value)){
					alert("<fmt:message key='javascript.httpcommandconfig.path.illegal' />");
					document.forms[0].path.focus();
					return;
				}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> <html:form action="SaveHttpCommandReplyAction">
          ...
          <td  align="center" valign="top"> <div class="bodyhdr"> 
              <div align="right"> 
                <p><span class="section">	
			        	<fmt:message key="editHttpCommandReply.title" />
              	   </span>
              <html:hidden property="id" value="${httpcommand.id}" />
        ...
        <tr> 
          <td  align="center" valign="top"> <div align="left">
			...
			<tr class="bg-shallow">
              ...
              <td width="70%" ><html:text property="ip" value="${httpcommand.ip}"  styleClass="field" onfocus="fnSetStyle(this)" onblur="fnRemoveStyle(this)"/><font color='red'>*</font></td>
            </tr>
           <tr class="bg-shallow">
              <td width="30%"  >&nbsp;&nbsp;<fmt:message key="listHttpCommandReply.port" /></td>
              <td width="70%" ><html:text property="port" value="${httpcommand.port}"  styleClass="field" onfocus="fnSetStyle(this)" onblur="fnRemoveStyle(this)"/><font color='red'>*</font></td>
            </tr>
            <tr class="bg-shallow">
              <td width="30%"  >&nbsp;&nbsp;<fmt:message key="listHttpCommandReply.path" /></td>
              <td width="70%" ><html:text property="path" value="${httpcommand.path}"  styleClass="field" onfocus="fnSetStyle(this)" onblur="fnRemoveStyle(this)"/><font color='red'>*</font></td>
            </tr>
            <tr class="bg-shallow">
              <td width="30%"  >&nbsp;&nbsp;<fmt:message key="listHttpCommandReply.username" /></td>
              <td width="70%" ><html:text property="username" value="${httpcommand.userName}"  styleClass="field" onfocus="fnSetStyle(this)" onblur="fnRemoveStyle(this)"/></td>
            </tr>
              <tr class="bg-shallow">
              <td width="30%"  >&nbsp;&nbsp;<fmt:message key="listHttpCommandReply.password" /></td>
              <td width="70%" ><html:text property="password" value="${httpcommand.password}"  styleClass="field" onfocus="fnSetStyle(this)" onblur="fnRemoveStyle(this)"/></td>
            </tr>

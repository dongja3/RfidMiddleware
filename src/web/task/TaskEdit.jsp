...
<html>
	<head>
        ...
        var filetext=
         ...
         <c:choose>
	     <c:when test="${task.parameter eq '1'}"> 
		  paramListBox=paramListBox+"<option value=\"1\" selected>GTIN</option>"
	     </c:when>
	    <c:otherwise> 
	        paramListBox=paramListBox+"<option value=\"1\" >GTIN</option>"
	    </c:otherwise> 
        </c:choose>
        
        <c:choose>
	    <c:when test="${task.parameter eq '2'}"> 
		paramListBox=paramListBox+"<option value=\"2\" selected>SSCC</option>"
	    </c:when>
	    <c:otherwise> 
		paramListBox=paramListBox+"<option value=\"2\" >SSCC</option>"
	    </c:otherwise> 
        </c:choose>
			
	var paramInputBox="<input type=\"text\" name=\"parameter\" value=\"${task.parameter}\" class=\"field\" onfocus=\"fnSetStyle(this)\" onblur=\"fnRemoveStyle(this)\"/>"
...
//-------------------------------------
		...
		function SelectGroup(){
				...
				function clickSubmit(){
					...
					if(!checkHttpDestination())
						return false;
					if(!checkFileDestination())
						return false;
...
<html:hidden property="groupId" value="${task.groupId}" />
<html:hidden property="dId" value="${task.deviceId}" />
        ...
        <tr>
          <td nowrap  align="center" valign="top"> <div align="left">
            ...
            <tr class="bg-shallow">
            	...
            	<td nowrap width="70%" class="bg-shallow">
				<html:text property="taskName" value="${task.taskName}" styleClass="field" onfocus="fnSetStyle(this)" onblur="fnRemoveStyle(this)"  />	
				<font color="red">*</font>				
			</td>
            </tr>
			<tr class="bg-shallow">
            	...
            	<td nowrap width="70%" class="bg-shallow">
					<select name="taskType" Class="field" onChange="setTaskType()">
						<option value="M" <c:if test="${task.taskType eq 'M'}">selected</c:if>><fmt:message key="task.taskType.M"/></option>
						<option value="A" <c:if test="${task.taskType eq 'A'}">selected</c:if>><fmt:message key="task.taskType.A"/></option>
					</select>
				</td>
            </tr>
            <tr class="bg-shallow">
            	...
            	<td nowrap width="70%" class="bg-shallow">
            		<html:select property="startup" styleClass="field">
						<option value="A" <c:if test="${task.startup eq 'A'}">selected</c:if>><fmt:message key="task.startupType.A"/></option>
						<option value="M" <c:if test="${task.startup eq 'M'}">selected</c:if>><fmt:message key="task.startupType.M"/></option>
					</html:select>
				</td>
            </tr>
            <tr class="bg-shallow">
            	...
            	<td nowrap width="70%" class="bg-shallow">
            		<html:select property="triggerMode" styleClass="field"  onchange="setTriggerMode()" >
						<option value="A" <c:if test="${task.triggerMode eq 'A'}">selected</c:if>><fmt:message key="task.triggermode.A"/></option>
						<option value="R" <c:if test="${task.triggerMode eq 'R'}">selected</c:if>><fmt:message key="task.triggermode.R"/></option>
						<option value="E" <c:if test="${task.triggerMode eq 'E'}">selected</c:if>><fmt:message key="task.triggermode.E"/></option>
						<option value="I" <c:if test="${task.triggerMode eq 'I'}">selected</c:if>><fmt:message key="task.triggermode.I"/></option>
						<option value="N" <c:if test="${task.triggerMode eq 'N'}">selected</c:if>><fmt:message key="task.triggermode.N"/></option>
						<option value="P" <c:if test="${task.triggerMode eq 'P'}">selected</c:if>><fmt:message key="task.triggermode.P"/></option>
					</html:select>
				</td>
            </tr>
           ...
           <tr class="bg-shallow">
            	...
            	<td nowrap width="70%" class="bg-shallow">
            		<html:select property="formatType" styleClass="field">
						<option value="F" <c:if test="${task.formatType eq 'F'}">selected</c:if>><fmt:message key="task.formatType.F"/></option>
						<option value="S" <c:if test="${task.formatType eq 'S'}">selected</c:if>><fmt:message key="task.formatType.S"/></option>
					</html:select>
				</td>
            </tr>
          </table>
          ...
          <table width="100%"  border="0" cellspacing="2" cellpadding="2">
            ...
            <tr class="bg-shallow">
            	...
            	<td nowrap width="70%" class="bg-shallow">
            		<html:text property="command" value="${task.command}" styleClass="field" onfocus="fnSetStyle(this)" onblur="fnRemoveStyle(this)" />&nbsp;
				</td>
            </tr>
            <tr class="bg-shallow">
            	...
            	<td nowrap width="70%" class="bg-shallow">
              		<html:select property="readerID" styleClass="field">
						<option value="N" <c:if test="${task.readerID eq 'N'}">selected</c:if>>Device Name</option>
						<option value="I" <c:if test="${task.readerID eq 'I'}">selected</c:if>>Device ID</option>
					</html:select>
				</td>
            </tr>
            <tr class="bg-shallow">
            	...
            	<td nowrap width="70%" class="bg-shallow">
            		...
            		<html:select property="topLevelID" styleClass="field">
						<option value="M" <c:if test="${task.topLevelID eq 'M'}">selected</c:if>>Middleware Name</option>
						<option value="G" <c:if test="${task.topLevelID eq 'G'}">selected</c:if>>Device Group Name</option>
					</html:select>
				</td>
            </tr>
              <tr class="bg-shallow">
            	...
            	<td nowrap width="70%" class="bg-shallow">
		    	<html:text property="description" value="${task.description}" styleClass="field" size="40" onfocus="fnSetStyle(this)" onblur="fnRemoveStyle(this)"  /> &nbsp;
				</td>
            </tr>
            <tr class="bg-shallow">
